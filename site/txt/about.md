...
You can also access them through [[//git.gay/pnppl/pnppl.cc/|the]] [[//codeberg.org/pnppl/pnppl.cc|git]] [[//github.com/pnppl/pnppl.cc|repo]], which handily doubles as a version history and complete source of the site. If you just want to grab all the posts in plaintext, that's at [[/txt/_txt.zip]].

# English annoyances
#list #language #pedantry

what they say (what I wish they'd say)
...
- narcotic (drug, psychoactive)
- weary of (wary of, tired of)
- whence (when)

## Euphemism/Censorship
- corn (porn)
- crossed the rainbow bridge (died)
- euthanized (killed)
- f*ck (fuck)
- passed, passed away, passed on (died)
- PDF file (pedophile)
- put down (killed)
- sui (suicide)
- trying to get pregnant (fucking raw)
- unalive (kill)
...
[^mf]: Go to the hardware store sometime and tell them you need a penis-penis adapter.

...
zip -ur site/txt/!txt.zip site/txt/ -i \*.md &&
zip -ur site/img/1bitday/!1bitday.zip site/img/1bitday/ -i \*.gif
set imagetypes '\*.gif' '\*.jpg' '\*.jpeg' '\*.png'
zip -ur site/img/comics/!comics.zip site/img/comics/ -i $imagetypes  &&
zip -ur site/img/photos/!photos.zip site/img/photos/ -i $imagetypes &&
fish epub/epub.fish
chmod -R 755 site/ &&
